...
def newplot(title="IEC", plotType="Loading"):
    ...
    if plotType == "Loading":
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.append(
            "ax[1].plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.clear()
        diagrams.append(
            "ax1.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
                                sim_res['column.column_section[8].outlet.c[1]'], label='P', color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax1.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.append(
            "ax2.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
                                sim_res['uv_detector.value'], label='UV', color='k', linestyle=linetype)"
        )
        diagrams.append(
            "ax2.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.clear()
        diagrams.append(
            "ax1.plot((sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'))/model_get('column.V'), \
                                sim_res['column.column_section[8].outlet.c[1]'], label='P', color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax1.plot((sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'))/model_get('column.V'), \
        ...
        diagrams.append(
            "ax2.plot((sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'))/model_get('column.V'), \
                                sim_res['uv_detector.value'], label='UV', color='k', linestyle=linetype)"
        )
        diagrams.append(
            "ax2.plot((sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'))/model_get('column.V'), \
        ...
        diagrams.append(
            "ax3.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.append(
            "ax4.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
                                sim_res['tank_buffer2.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax5.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.append(
            "ax6.plot(sim_res['ackF'] - parValue['start_desorption']*model_get('F')/model_get('control_desorption_buffer.scaling'), \
                                sim_res['tank_harvest.V'], color='g', linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax1.plot(sim_res['ackF']/model_get('column.V'), sim_res['column.column_section[8].outlet.c[1]'], label='P', color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax1.plot(sim_res['ackF']/model_get('column.V'), sim_res['column.column_section[8].outlet.c[2]'], label='A', color='r', linestyle=linetype)"
        )
        diagrams.append("ax1.legend()")
        diagrams.append(
            "ax2.plot(sim_res['ackF']/model_get('column.V'), sim_res['conductivity_detector.value'], color='m', linestyle=linetype)"
        )
        diagrams.append(
            "ax3.step(sim_res['ackF']/model_get('column.V'), sim_res['tank_sample.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax4.plot(sim_res['ackF']/model_get('column.V'), sim_res['tank_buffer1.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax5.plot(sim_res['ackF']/model_get('column.V'), sim_res['tank_buffer2.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax6.plot(sim_res['ackF']/model_get('column.V'), sim_res['tank_harvest.V'], color='g', linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax1.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['column.column_section[8].outlet.c[1]'], label='P', color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax1.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
        ...
        diagrams.append(
            "ax2.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['conductivity_detector.value'], color='m', linestyle=linetype)"
        )
        diagrams.append(
            "ax3.step(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['tank_sample.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax4.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['tank_buffer1.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax5.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['tank_buffer2.Fsp'], color='g', linestyle=linetype)"
        )
        diagrams.append(
            "ax6.plot(sim_res['time']-parValue['start_desorption']/model_get('control_desorption_buffer.scaling'), \
                       sim_res['tank_harvest.V'], color='g', linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax1.plot(sim_res['ackF']/model_get('column.V'), \
                                sim_res['column.column_section[8].outlet.c[1]'], label='P', color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax1.plot(sim_res['ackF']/model_get('column.V'), \
        ...
        diagrams.append(
            "ax2.plot(sim_res['ackF']/model_get('column.V'), \
                                sim_res['uv_detector.value'], label='UV', color='k', linestyle=linetype)"
        )
        diagrams.append(
            "ax2.plot(sim_res['ackF']/model_get('column.V'), \
        ...
        diagrams.append(
            "ax3.step(sim_res['ackF']/model_get('column.V'), \
                                sim_res['control_pooling.out'], color='k', linestyle=linetype)"
        )
        diagrams.append("ax3.set_xlim(left=0)")
...
def describe(name, decimals=3):
    ...
    if name == "chromatography":
        ...
        P = model_get("liquidphase.P")
        P_description = model_get_variable_description("liquidphase.P")
        P_mw = model_get("liquidphase.mw[1]")
        A = model_get("liquidphase.A")
        A_description = model_get_variable_description("liquidphase.A")
        ...
        PS = model_get("liquidphase.PS")
        PS_description = model_get_variable_description("liquidphase.PS")
        PS_mw = model_get("liquidphase.mw[4]")
        AS = model_get("liquidphase.AS")
        AS_description = model_get_variable_description("liquidphase.AS")
